    ...
    def test_links_overload(self):
        ...
        with open(os.path.join(DATA_ROOT, "links_overload.html")) as f:
            ...
            urls = [
                ...
                make_tagged_url("http://pdf.lesoir.be/", u"""Dans Le Soir en PDF : Michel Daerden était hors normes""", set(['to read', 'internal', 'sidebar box', 'internal site', 'pdf newspaper'])),
                ...
                make_tagged_url("http://pdf.lesoir.be/", u"""Le Soir""", set(['internal', 'internal site', 'pdf newspaper', 'in text'])),
